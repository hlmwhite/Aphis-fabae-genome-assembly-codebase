# Aphis-fabae-genome-assembly-codebase
Genome assembly code for Aphis fabae genome paper

here you will find the following files:
- genomeAsmComms.sh - assembly commands the A. fabae genome and mitochondrial genome
